...
const Profile = () => {
    ...
    // HTML parameter to pass to Airtable to point to shared link ID
    ...
    // useState to display default shared designer's profilePreview and then reveals it on sign in
    const [profilePreview, revealProfile] = useState([]);
    
    // Register viewer session via CreateViewerSession.js
